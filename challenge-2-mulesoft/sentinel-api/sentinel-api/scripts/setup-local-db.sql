-- =============================================================
-- Sentinel API - Local Database Setup
-- Run this against your local SQL Server to create the database
-- and all 162 stub stored procedures.
--
-- Usage (sqlcmd):
--   sqlcmd -S localhost -U sa -P '<YourPassword>' -i scripts/setup-local-db.sql
--
-- Usage (Docker SQL Server):
--   sqlcmd -S localhost,1433 -U sa -P '<YourPassword>' -i scripts/setup-local-db.sql
-- =============================================================
...
-- Step 2: Create all 162 stub stored procedures
-- Each proc returns a single row with _stub='STUB' and _procName=<name>
-- This allows the NestJS app to connect and call procs without errors.

-- ─────────────────────────────────────────────────────────────
-- Reference Data Procs (REF)
-- ─────────────────────────────────────────────────────────────
...
-- =============================================================
-- Done! All 162 stub procedures created.
-- =============================================================
PRINT 'SUCCESS: All 162 stub stored procedures created in DigitalServiceDataStore.';
GO
